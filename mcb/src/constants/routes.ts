...
export const ROUTES = {
  ...
  BROWSE_JOBS_LIST: '/jobs/browse/list',
  BROWSE_JOBS_GRID: '/jobs/browse/grid',
  BROWSE_JOBS_FILTER_LIST: '/jobs/browse/filter-list',
  BROWSE_JOBS_FILTER_GRID: '/jobs/browse/filter-grid',
  JOBS_BY_COMPANY: '/jobs/company',
  JOBS_BY_DESIGNATION: '/jobs/designations',
  JOBS_BY_CATEGORY: '/jobs/category',
  JOBS_BY_LOCATION: '/jobs/location',
  JOBS_BY_SKILLS: '/jobs/skills',
...
export const NAVIGATION_MENU = {
  ...
  EMPLOYER_DASHBOARD: [
    ...
    { label: 'Company Overview', path: ROUTES.COMPANY_OVERVIEW },
