...
const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  const canonicalUrl = canonical || (typeof window !== 'undefined' ? window.location.href : 'https://mcb.com');
  
  // Generate Open Graph URL safely
  const ogUrlFinal = ogUrl || (typeof window !== 'undefined' ? window.location.href : 'https://mcb.com');
  ...
  return (
    <Helmet>
      ...
      <meta name="author" content="MCB - MyCareerBuild" />
      ...
      <meta property="og:site_name" content="MCB - MyCareerBuild" />
      ...
      <meta name="twitter:site" content="@mcbjobs" />
      <meta name="twitter:creator" content="@mcbjobs" />
      ...
      <meta name="apple-mobile-web-app-title" content="MCB Jobs" />
